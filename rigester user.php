...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO users (firstname, lastname, email, address, password, departement, phonenumber)
        VALUES ('$firstname', '$lastname', '$email', '$address', '$pass', '$department', '$phone')";
    ...
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
        ...
        <select name="department">
            <option value="Select departement">Select Department</option>
            <option value="department1">Site Manager</option>
