...
<body>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul id="siteDropdown" class="dropdown-menu">
                            ...
                            <li><a href="allsites.php">All sites</a></li>
                    ...
                    <li>
                       ...
                       <li>
                        <a href="#" onclick="toggleDropdown(event)">
                            <i class="fas fa-cogs"></i>
                            <div class="title">Department Management</div>
                        </a>
                        <ul id="productDropdown" class="dropdown-menu">
                            <li><a href="adddepartment.php">Add Department</a></li>
                            <li><a href="allsitesdepart.php">All Department</a></li>
                            <li><a href="updatedepartmentt.html">Edit Department</a></li>
                        </ul>
                    </li>
                </ul>
                <li>
        ...
        <div class="main">
            ...
            <div class="cards">
                <div class="card">
                    ...
                    <div class="number">
    <?php
    // Assuming you have not established a database connection yet
    ...
    // Query to count the number of records in the "users" table
