...
if (isset($_GET["id"]) && isset($_GET["confirm"])) {
    ...
    if ($_GET["confirm"] === "yes") {
        // Prepare and execute the SQL query to delete the department with the corresponding ID
        $deleteSql = "DELETE FROM department WHERE departid = $id";
        ...
        echo "Department deletion canceled.";
    }
}

// Prepare and execute the SQL query to select departments from the database
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>";
        echo "<a href='javascript:void(0)' onclick='confirmDelete(" . $row["departid"] . ")'>Delete</a> | ";
        echo "<a href='?departid=" . $row["departid"] . "&confirm=no'>Cancel</a>";
        echo "</td>";
        echo "</tr>";
    }
} else {
